...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="scroll-mt-28 mb-28 sm:mb-40 relative z-20 w-full max-w-[53rem]">
      ...
      <div className="relative container mx-auto px-6 flex flex-col space-y-8">
        {/* The Central Glowing Line (Timeline) */}
        <div className="absolute left-8 sm:left-1/2 top-0 h-full w-[2px] bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 opacity-30 -translate-x-1/2 md:translate-x-0" />
        ...
        {experiencesData.map((item, index) => (
          ...
          >
            {/* 1. The Timeline Node (Icon) */}
            <div className="absolute left-8 sm:left-1/2 -translate-x-1/2 flex items-center justify-center">
              <div className="w-12 h-12 rounded-full bg-black border border-white/10 shadow-[0_0_20px_rgba(168,85,247,0.4)] flex items-center justify-center z-20 relative">
            ...
            <div className={`w-full sm:w-[45%] pl-20 sm:pl-0 ${
              ...
              <div className="bg-white/5 border border-white/10 p-6 rounded-2xl backdrop-blur-md hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300 group shadow-lg hover:shadow-[0_0_30px_rgba(139,92,246,0.1)]">
